...
class FeaturedSongsPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Bài hát nổi bật', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
      ...
      body: featuredTracksAsync.when(
        data: (tracks) {
          if (tracks.isEmpty) {
            return const Center(
              child: Text('Không có bài hát nổi bật nào.', style: TextStyle(color: Colors.white70)),
            );
          }
