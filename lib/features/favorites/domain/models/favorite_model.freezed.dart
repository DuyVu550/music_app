...
mixin _$FavoriteModel {
 ...
 String get id; String get userId; String get trackId; DateTime get createdAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FavoriteModel&&(identical(other.id, id) || other.id == id)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.trackId, trackId) || other.trackId == trackId)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,trackId,createdAt);

@override
String toString() {
  return 'FavoriteModel(id: $id, userId: $userId, trackId: $trackId, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String userId, String trackId, DateTime createdAt
});
...
/// Create a copy of FavoriteModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? trackId = null,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  String trackId,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FavoriteModel() when $default != null:
return $default(_that.id,_that.userId,_that.trackId,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userId,  String trackId,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _FavoriteModel():
return $default(_that.id,_that.userId,_that.trackId,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String userId,  String trackId,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _FavoriteModel() when $default != null:
return $default(_that.id,_that.userId,_that.trackId,_that.createdAt);case _:
  return null;
...
class _FavoriteModel implements FavoriteModel {
  const _FavoriteModel({required this.id, required this.userId, required this.trackId, required this.createdAt});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FavoriteModel&&(identical(other.id, id) || other.id == id)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.trackId, trackId) || other.trackId == trackId)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}
...
/// Create a copy of FavoriteModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? trackId = null,Object? createdAt = null,}) {
